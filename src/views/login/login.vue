<template>
  <div id="login_2" class="animate__animated animate__fadeIn">
    <div class="dowebok">
          ...
          <el-form
            ...
            <el-form-item class="form-item" prop="username">
                <input autocomplete="off"
                  id="username" :placeholder="$t('m.placeholder.username')"
              ...
              <el-form-item class="form-item" prop="password">
                <input :placeholder="$t('m.placeholder.password')"
                  id="password"
                  style="background-color:transparent !important;"
          ...
          <div class="form-item"><button id="submit" @click="login('form')"><i v-if="loginStatus" class="el-icon-loading"></i>{{ $t('m.login.login') }}</button></div>
          <!-- <div class="reg-bar">
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        username: [
          { required: true, message: this.$i18n.t('m.rules.account'), trigger: 'blur' },
          { min: 1, max: 12, message: '长度在 7 到 12 个字符', trigger: 'blur' }
        ],
        password: [
          { required: true, message: this.$i18n.t('m.rules.password'), trigger: 'blur' },
          { min: 1, max: 12, message: '长度在 7 到 12 个字符', trigger: 'blur' }
        ]
      }
    }
...
// }
  #login_2{
    ...
    position: absolute;
    left: calc(50% - 215px); top: calc(50% - 275px);
    width: 430px;
    height: 550px;
